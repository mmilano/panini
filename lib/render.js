...
function render(file, enc, cb) {
  ...
  try {
    ...
    // console.log ("render: pagebody:", page.body);  // DEV. outputs the page.html content, with linebreaks, etc. but NOT RENDERED YET
    ...
    // this.currentPage = pageTemplate(pageData);  // this doesnt work

    // extend the page data object with the rendered page >body contents.
    // so that it can be accessed from other parts of the render process
    pageData = extend(pageData, {
