...
/**
 * Looks for files with .json or .yml extensions within the data directory, and adds them as Handlebars variables matching the name of the file.
 * @param {string} dir - Folder to check for data files.
 */
module.exports = function(dir) {

    // allow for the data files to be located within the panini options root location
    var fullDir = this.options.root + dir;
    //   var dataFiles = utils.loadFiles(dir, '**/*.{js,json,yml}');
    var dataFiles = utils.loadFiles(fullDir, '**/*.{js,json,yml}');
